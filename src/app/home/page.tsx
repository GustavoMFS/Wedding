      ...
      <GuestLayout>
        ...
        >
          ...
          <section className="text-center px-6 max-w-2xl mx-auto">
            <p className="text-2xl font-[MonetaBold] text-[#000000]">
          ...
          >
            ...
            <p className="py-1 text-2xl font-[MonetaBold] text-[#000000]">
              {messages.date}
            </p>
            <p className="py-1 text-2xl font-[MonetaBold] text-[#000000]">
              {messages.time}
          ...
          <section className="text-center px-6 max-w-2xl mx-auto" id="regras">
            ...
            <p className="py-2 text-2xl font-[MonetaBold] text-[#000000]">
          ...
          >
            ...
            <p className="text-2xl font-[MonetaBold] max-w-xl mx-auto text-[#000000]">
          ...
          <section className="text-center px-6 pb-10 max-w-2xl mx-auto">
            ...
            <p className="text-2xl font-[MonetaBold] max-w-lg mx-auto text-[#000000]">
